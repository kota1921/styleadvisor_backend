...
Буду далее следовать этому алгоритму при добавлении/изменении функциональности.
...
```
Если переменная не найдена — выбрасывается ошибка (fail-fast), чтобы н�� пропустить неправильную конфигурацию.
